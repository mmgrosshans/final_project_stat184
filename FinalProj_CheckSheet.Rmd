...
(A) .Rmd Line numbers where at least two different data sources are imported: Lines 34-39, 44-49


(B) .Rmd Line numbers for inspecting data intake: Lines 40 and 50
...
(A) .Rmd Line number(s) for general data wrangling: Lines 65-66


(B) .Rmd Line number(s) for a join operation: Lines 57-58


(D) .Rmd Line number(s) for use of regular expressions: Lines 72-73


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: Lines 79-81


(H) .Rmd Line number(s) for use of machine learning: Lines 87-90
...
(A) .Rmd Line number(s) for use of mulitple different geoms: Lines 128-132, 136-140


(B) .Rmd Line number(s) for use of multiple aesthetics: Lines 98-99, 103-104


(C) .Rmd Line number(s) for use of layered graphics: Lines 112-114, 118-120
